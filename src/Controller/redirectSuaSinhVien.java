...
/**
 * Servlet implementation class redirectSuaSinhVien
 */
@WebServlet("/redirectSuaSinhVien")
public class redirectSuaSinhVien extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public redirectSuaSinhVien() {
        super();
